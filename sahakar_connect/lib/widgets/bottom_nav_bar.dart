...
class SahakarBottomNavBar extends StatelessWidget {
  final int currentIndex;
  final Function(int) onTap;

  const SahakarBottomNavBar({
    super.key,
          ...
          child: Row(
            ...
            children: [
              ...
              _buildNavItem(
                ...
                label: LocalizationService.t('workers'),
              ),
              _buildNavItem(
                index: 2,
                icon: Icons.work_history_rounded,
                label: LocalizationService.t('worker_portal'),
              ),
              _buildNavItem(
                index: 3,
